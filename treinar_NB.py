...
for datasetnum in range(1,6):
    ...
    for tipo in tipos:
        ...
        # Salvar o model
        Gravar_Dados('pesos/GNB/reconhecer_dataset'+str(datasetnum)+'_'+tipo+'.pickle',reconhecer_pessoa)

        # Gravar o label encoder (conversor para inteiro)
        Gravar_Dados('pesos/GNB/encoder_dataset'+str(datasetnum)+'_'+tipo+'.pickle',encoder)
